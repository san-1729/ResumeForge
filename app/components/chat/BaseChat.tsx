      ...
      >
        ...
        <div ref={scrollRef} className="flex overflow-y-auto w-full h-full">
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow min-w-[var(--chat-min-width)] h-full')}>
            {!chatStarted && (
              <div id="intro" className="mt-[26vh] max-w-chat mx-auto relative z-10">
                ...
                <p className="mb-6 text-center text-bolt-elements-textSecondary animate-fade-in animation-delay-300">
                  Create professional, ATS-optimized resumes and stand out to recruiters.
                </p>
                <div className="w-16 h-1 bg-blue-500 mx-auto rounded-full mb-6 animate-fade-in animation-delay-500"></div>
              </div>
            )}
            <div
                  ...
                  {EXAMPLE_PROMPTS.map((examplePrompt, index) => {
                    return (
                      <button
                        ...
                        className={`group flex items-center w-full gap-2 justify-between px-4 py-3 bg-gray-900 hover:bg-gray-800 text-gray-400 hover:text-white rounded-lg transition-all border border-gray-800 hover:border-blue-500 animate-fade-in shadow-md`}
